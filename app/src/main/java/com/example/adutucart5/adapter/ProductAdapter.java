...
import com.example.adutucart5.activity.ProductActivity;
import com.example.adutucart5.activity.ProductViewActivity;
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= Php." + _subtotal);
